...
const styles = StyleSheet.create({
  ...
  image: { width: 270, height: 202, marginBottom: 0, marginLeft: 12 },
  ...
  inputWrapper: {
    width: '100%',
    flexDirection: 'row', // عشان الأيقونة تتواجد على اليسار والنص على اليمين
    alignItems: 'center',
    borderWidth: 1,
    borderColor: '#ccc',
    borderRadius: 25,
  ...
  input: {
    flex: 1, // تتيح للنص التمدد داخل الـ input
    padding: 10,
    fontSize: 16,
  },
  iconLeft: {
    marginLeft: 10,  // المسافة بين الأيقونة والنص
    marginRight: 10, // المسافة بين الأيقونة والنص
  },
});
